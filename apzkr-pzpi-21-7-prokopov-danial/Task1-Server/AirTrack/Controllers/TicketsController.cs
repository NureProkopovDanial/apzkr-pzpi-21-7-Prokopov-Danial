...
namespace AirTrack.Controllers
{
    ...
    public class TicketsController : ControllerBase
    {
        ...
        public TicketsController(AppContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.Ticketes.Include(c => c.Passenger).Include(c => c.Flight).ToListAsync();
        }
        ...
        {
            return _context.Ticketes.Any(e => e.TicketId == id);
        }
    }
}

...
namespace AirTrack.Controllers
{
    ...
    public class PassengersController : ControllerBase
    {
        ...
        public PassengersController(AppContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Passengers
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Passenger>>> GetPasses()
        {
        ...
        {
            var passenger = await _context.Passes.FindAsync(id);
        ...
        public async Task<IActionResult> DeletePassenger(int id)
        {
            ...
            _context.Passes.Remove(passenger);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.Passes.Any(e => e.PassengerId == id);
        }
    }
}

...
import { editTicket } from '../../../http/ticketApi';
import { IFlight } from '../../../interfaces/IFlight';
import { IPassenger } from '../../../interfaces/IPassenger';
import { ISelect } from '../../../interfaces/ISelect';
import { ITicket } from '../../../interfaces/ITicket';
import { ITicketCreateData } from './TicketCreateModal';
...
interface IProps {
  ...
  export interface ITicketEditData extends ITicketCreateData {
    ticketId: number,
  }

export const TicketEditModal = ({ show, onHide, item, fetch }: IProps) => {
    const {
        control,
        handleSubmit,
        reset,
        formState: { errors },
      } = useForm<ITicketEditData>();
      ...
      const onSubmit = async (data: ITicketEditData) => {
        await editTicket(data.ticketId, data)
          .then(() => {
            onHide();
            fetch();
          })
